...
public class Part2 {
    ...
    public static void main (String[] args) throws IOException {
        List<String> lines = Files.readAllLines(Paths.get("C:\\workspace\\AoC2016\\Day23\\src\\main\\resources\\newInput.txt"));
        ...
        while (pointer < lines.size()) {
            ...
            switch (instruction) {
                case "mul":
                    String aRegister = line.split(" ")[1];
                    String bRegister = line.split(" ")[2];

                    registers.put("a", registers.get(aRegister) * registers.get(bRegister));
                    pointer++;
                    break;
                case "cpy":

...
public class Part2 {
    private static ArrayList<String> input = new ArrayList<>(Arrays.asList("fbgdceah".split("")));
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (String line : lines) {
            ...
            if (m.find()) {
                int firstPosition = Integer.parseInt(m.group(2));
                int secondPosition = Integer.parseInt(m.group(1));
    ...
    private static void rotate(String character) {
        int[] rotationAmounts = new int[] {-9, -1, -6, -2, -7, -3, -8, -4};
        int index = input.indexOf(character);
        int rotationAmount = rotationAmounts[index];

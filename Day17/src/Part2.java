...
public class Part2 {
    private static final String input = "ulqzkmiv";
    ...
    public static void main (String[] args) {
        ...
        while (!queue.isEmpty()) {
            ...
            if (currentPoint.contains("3,3")) {
                completePaths.add(currentPoint.substring(4));
                continue;
            }
        ...
        completePaths.sort(new CompareUsingLength());
        System.out.println(completePaths.get(0).length());
